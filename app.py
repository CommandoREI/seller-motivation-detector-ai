...
Seller: We need to close within 30 days if possible. The house needs some work but we're flexible on price for a quick sale."></textarea>
    ...
    <!-- Disclaimer Section -->
    <div style="max-width: 1200px; margin: 60px auto 40px; padding: 30px; background: #f8f9fa; border-top: 3px solid #2e7d32; border-radius: 8px;">
        <h3 style="color: #2e7d32; margin-top: 0; font-size: 18px; font-weight: 600;">⚖️ Disclaimer & Legal Notice</h3>
        <div style="font-size: 12px; line-height: 1.6; color: #555;">
            <p style="margin: 10px 0;">This AI-powered tool is designed to assist real estate investors in analyzing seller conversations and identifying potential motivation indicators. The analysis provided is for <strong>informational and educational purposes only</strong> and should not be considered as professional legal, financial, or investment advice.</p>
            
            <p style="margin: 10px 0; font-weight: 600; color: #333;">Important Considerations:</p>
            <ul style="margin: 10px 0; padding-left: 20px;">
                <li><strong>AI Limitations:</strong> Results are generated by artificial intelligence and may contain inaccuracies or misinterpretations. Always verify information independently.</li>
                <li><strong>Professional Judgment Required:</strong> This tool is meant to supplement, not replace, your professional experience and due diligence.</li>
                <li><strong>No Guarantees:</strong> Motivation scores and recommendations are estimates based on language patterns and do not guarantee seller behavior or deal outcomes.</li>
                <li><strong>Your Responsibility:</strong> Any investment decisions, offers, or negotiations made based on this analysis are entirely at your own discretion and risk.</li>
                <li><strong>Privacy:</strong> Do not upload recordings without proper consent. Ensure compliance with local recording laws and privacy regulations.</li>
            </ul>
            
            <p style="margin: 15px 0 10px; font-size: 11px; color: #666; font-style: italic;">By using this tool, you acknowledge that Real Estate Commando and its affiliates are not liable for any decisions, actions, or outcomes resulting from the use of this analysis.</p>
            
            <p style="margin: 10px 0; font-size: 11px; color: #888; border-top: 1px solid #ddd; padding-top: 10px;">
                <strong>Version:</strong> 1.0.0 | <strong>Last Updated:</strong> November 2025
            </p>
        </div>
    </div>
